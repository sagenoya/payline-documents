...
export default async function DashboardPage() {
  ...
  const [documentCount, folderCount, userCount, recentDocuments] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_420px]">
        <div className="space-y-3">
          ...
          <DocumentList documents={recentDocuments} emptyText="No documents have been uploaded yet." />
        </div>
        <div className="space-y-3">
          <h2 className="text-base">Activity</h2>
          <RecentActivity take={10} />
